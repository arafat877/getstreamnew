...
import { StreamClient, OnUploadProgress, RefreshUrlAPIResponse } from 'getstream/src/client';
export declare class StreamFileStore {
     ...
     */
    upload(uri: string | File | Buffer | NodeJS.ReadStream, name?: string, contentType?: string, onUploadProgress?: OnUploadProgress): Promise<import("getstream/src/client").FileUploadAPIResponse>;
    /**
